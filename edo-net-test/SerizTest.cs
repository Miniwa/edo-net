...
namespace Edo
{
    ...
    public class SerizTest
    {
        ...
        public void TestSerialize()
        {
            Int32 number = 12314;
            Stream.SetLength(4);
            Seriz.Serialize(number, Stream.GetBuffer());
